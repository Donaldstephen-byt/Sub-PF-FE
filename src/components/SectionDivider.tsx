...
function Dividers() {
  return (
    <div>
      ...
      <div
        className="sm:col-span-2 lg:col-span-3 h-0.5 w-full my-6 
  ...
  shadow-[0_0_25px_4px_rgba(99,102,241,0.2)]"
      ...
      <div className="sm:col-span-2 lg:col-span-3 my-6 w-full flex flex-col gap-1">
        <div className="h-px w-full bg-linear-to-r from-transparent via-indigo-500/70 to-transparent"></div>
        <div className="h-px w-full bg-linear-to-r from-transparent via-purple-500/40 to-transparent opacity-70"></div>
      </div>

      {/* FOURTH DIVIDER */}
      <div className="sm:col-span-2 lg:col-span-3 w-full my-6 flex justify-center">
        <div className="w-2/3 h-px bg-linear-to-r from-transparent via-indigo-400/50 to-transparent relative">
          <div
      ...
      <div className="sm:col-span-2 lg:col-span-3 w-full my-6 flex items-center">
        <div className="grow h-px bg-linear-to-r from-transparent via-indigo-500/50 to-transparent"></div>
      ...
      {/* SIXTH DIVIDER */}
      <div
        className="sm:col-span-2 lg:col-span-3 w-full my-6 h-0.5 
  bg-indigo-400/20 blur-sm"
      ...
      <div className="sm:col-span-2 lg:col-span-3 relative w-full my-6">
        <div className="h-0.5 w-full bg-linear-to-r from-transparent via-indigo-500/60 to-transparent blur-[1px]"></div>
        <div className="absolute inset-0 h-px bg-linear-to-r from-transparent via-indigo-300 to-transparent"></div>
      </div>
      ...
      <div className="sm:col-span-2 lg:col-span-3 w-full my-8">
        <div className="relative w-full">
          <div className="h-0.5 bg-linear-to-r from-transparent via-indigo-500/60 to-transparent"></div>
          <div className="absolute inset-0 h-1.5 bg-linear-to-r from-transparent via-indigo-400/20 to-transparent blur-md"></div>
        </div>
      </div>
    </div>
  );
