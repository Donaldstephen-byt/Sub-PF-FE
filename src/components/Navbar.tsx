...
import { Section, Divider, Dot } from "./NavDropdown";
          ...
          {mobileOpen && (
            <>
              ...
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="absolute top-full left-0 right-0 mt-2 mx-4 rounded-xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-white/20 shadow-xl p-4 md:hidden z-50"
                role="menu"
                ...
                <div className="flex flex-col gap-2">
                  {NAV_ITEMS.map((item) => (
                    <a
                      ...
                      href={item.href}
                      onClick={() => setMobileOpen(false)}
                      className="block px-4 py-3 rounded-lg text-slate-800 dark:text-slate-100 font-medium hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                      role="menuitem"
                    >
                      {item.name}
                    </a>
                  ...
                  {/* <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="search"
                        placeholder="Search..."
                        className="w-full rounded-lg pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border-none outline-none text-slate-900 dark:text-slate-100 placeholder:text-slate-500"
                      />
                    </div>
                  </div> */}
                </div>
